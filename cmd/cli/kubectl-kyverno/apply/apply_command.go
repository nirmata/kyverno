...
import (
	...
	"github.com/nirmata/kyverno/cmd/cli/kubectl-kyverno/utils/store"
	"github.com/kyverno/kyverno/pkg/clients/dclient"
	"github.com/kyverno/kyverno/pkg/config"
	"github.com/nirmata/kyverno/pkg/openapi"
	policy2 "github.com/kyverno/kyverno/pkg/policy"
	"github.com/nirmata/kyverno/cmd/cli/kubectl-kyverno/utils/common"
...
func Command() *cobra.Command {
	...
	cmd.Flags().StringVar(&applyCommandConfig.ResourceGitBranch, "resource-git-branch", "", "git repository branch of resources")
