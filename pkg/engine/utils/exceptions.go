...
func MatchesException(polexs []*kyvernov2alpha1.PolicyException, policyContext engineapi.PolicyContext, logger logr.Logger) []kyvernov2alpha1.PolicyException {
	var matchedExceptions []kyvernov2alpha1.PolicyException
