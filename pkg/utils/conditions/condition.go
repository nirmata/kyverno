...
func CheckAnyAllConditions(logger logr.Logger, ctx enginecontext.Interface, condition kyvernov1.AnyAllConditions) (bool, error) {
...
func checkCondition(logger logr.Logger, ctx enginecontext.Interface, condition kyvernov1.Condition) (bool, error) {
